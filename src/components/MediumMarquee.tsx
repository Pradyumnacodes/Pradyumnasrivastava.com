      ...
      >
        {doubled.map((s, i) => (
          <a
            ...
            style={{
              transition:
                "transform 220ms cubic-bezier(0.16, 1, 0.3, 1), box-shadow 300ms, z-index 0s",
            }}
          >
                ...
                <div className="flex items-center gap-4 pt-2 border-t border-black/10 text-[11px] font-mono">
                  {s.views && (
                    <span className="flex flex-col">
                      <span className="opacity-50 uppercase tracking-[0.12em] text-[9px]">
                        Views
                      </span>
