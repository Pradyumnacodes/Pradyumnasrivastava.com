  ...
  return (
    <div className="w-full relative mt-8 z-10">
      <motion.div 
        ...
        className="w-full relative overflow-hidden bg-background/60 dark:bg-black/60 backdrop-blur-3xl border border-foreground/10 dark:border-[#D4AF37]/20 rounded-[2rem] p-8 sm:p-10 flex flex-col items-center gap-10 shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.7)] ring-1 ring-inset ring-white/20 dark:ring-[#D4AF37]/10"
      >
        <div className="absolute inset-0 bg-gradient-to-tr from-foreground/5 dark:from-[#D4AF37]/15 via-transparent to-transparent opacity-50 pointer-events-none" />
        <div className="text-center flex flex-col items-center">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="w-16 h-16 rounded-full bg-foreground/5 dark:bg-[#D4AF37]/10 flex items-center justify-center mb-6 ring-1 ring-transparent dark:ring-[#D4AF37]/20"
          >
            <div className="w-2 h-2 rounded-full bg-foreground/60 dark:bg-[#D4AF37] animate-pulse shadow-[0_0_12px_rgba(212,175,55,0.8)]" />
          </motion.div>
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          <div className="grid grid-cols-2 gap-4 mt-2">
            <a 
              ...
              className="flex flex-col items-center justify-center gap-3 bg-surface dark:bg-black/60 hover:bg-foreground/5 dark:hover:bg-[#D4AF37]/10 py-5 rounded-2xl active:scale-[0.97] transition-all duration-300 border border-foreground/5 dark:border-[#D4AF37]/10 ring-1 ring-inset ring-white/10 dark:ring-[#D4AF37]/10 shadow-sm"
            >
